...
and after all lines have been read from the file, your program will have a slice containing one
struct for each line in the file. After reading all lines from the file, your program should iterate
...
func main() {
	...
	for line.Scan() {
		var person Person
		fmt.Sscanf(line.Text(), "%s %s", &person.fname, &person.lname)
		persons = append(persons, person)
	}
	// Print the slice of structs
